...
/* ── HERO (section-navy provides bg, border, position, overflow) ── */
#give-hero { padding: 64px 0 0; }
.gh-grid { grid-template-columns: 1fr 460px; gap: 52px; position: relative; z-index: 2; }
.gh-eyebrow {
...
.gh-h1 {
  font-size: clamp(44px, 6.5vw, 80px); line-height: .88;
  letter-spacing: -.04em; color: #fff; margin-bottom: 20px;
}
.gh-h1 em { font-style: italic; color: var(--red); }
.gh-sub {
  font-size: clamp(15px, 1.6vw, 18px); color: rgba(255,255,255,.6);
...
/* success */
.give-success { display: none; text-align: center; padding: 16px 0; }
...
/* ── IMPACT (section-cream provides bg, padding, border, position, overflow) ── */
.impact-grid { gap: 64px; position: relative; z-index: 2; }
.impact-pull {
  font-size: clamp(20px, 2.8vw, 32px); font-weight: 900;
  line-height: 1.2; margin-bottom: 22px;
}
.impact-pull .red { color: var(--red); }
.impact-body { font-size: 16px; line-height: 1.85; color: rgba(29,38,49,.7); }
.impact-body p + p { margin-top: 14px; }
.impact-table { border-radius: var(--radius); box-shadow: var(--shadow); }
.it-row { display: flex; align-items: center; gap: 16px; cursor: default; }
.it-amt {
  font-family: var(--font-head); font-size: 15px; font-weight: 900;
...
/* ── HOW IT WORKS (section-navy provides bg, padding, border, position, overflow) ── */
.how-grid { gap: 64px; position: relative; z-index: 2; }
.how-big {
  font-size: clamp(26px, 3.8vw, 46px); font-weight: 900;
  line-height: 1.1; color: #fff;
}
.how-big .y { color: var(--yellow); }
.how-big .r { color: var(--red); }
.how-sub { font-size: 15px; line-height: 1.85; color: rgba(255,255,255,.52); }
.how-sub p + p { margin-top: 12px; }
.how-list { border-radius: var(--radius); }
.how-item { padding: 20px 24px; }
.how-n {
  font-family: var(--font-head); font-size: 11px; font-weight: 900;
  color: var(--red); width: 28px; flex-shrink: 0; padding-top: 1px;
}
.how-t strong {
...
/* ── FINAL CTA (section-red provides bg, padding, border, position, overflow) ── */
#finalcta-c { padding: 80px 0; }
#finalcta-c .halftone { opacity: .06; }
.fc-inner { max-width: 500px; }
.fc-h { font-size: clamp(28px, 4.5vw, 52px); line-height: 1; margin-bottom: 12px; }
.fc-p { color: rgba(255,255,255,.88); margin-bottom: 26px; line-height: 1.6; }
</style>';
...
<!-- ① HERO + GIVE BOX -->
<section id="give-hero" class="section-navy">
  <div class="hero-dots"></div>
  <div class="glow-red"></div>
  <div class="glow-teal"></div>
  <div class="container">
    <div class="gh-grid grid-2">

      <!-- LEFT — emotional copy + proof -->
      <div class="reveal">
        <span class="gh-eyebrow">Omuto Foundation · Mpigi, Uganda · Est. 2019</span>
        <h1 class="gh-h1 t-hero">Your Gift<br/>Builds <em>Leaders.</em></h1>
        <p class="gh-sub t-body">Not handouts. Real systems, real young people, real change — built from within communities that are done waiting.</p>
        <div class="gh-proof">
          <div class="proof-row">
    ...
    <div class="stat-strip reveal">
      <div class="stat-strip-cell"><span class="stat-strip-num">47</span><span class="stat-strip-lbl">Completed Projects</span></div>
      <div class="stat-strip-cell" style="padding-left:24px"><span class="stat-strip-num">7,000+</span><span class="stat-strip-lbl">Youth Engaged</span></div>
      ...
      <div class="stat-strip-cell" style="padding-left:24px"><span class="stat-strip-num">2019</span><span class="stat-strip-lbl">Founded in Kammengo</span></div>
    </div>
  </div>
</section>

<!-- ② WHAT YOUR GIFT DOES -->
<section id="impact" class="section-cream">
  <span class="watermark" aria-hidden="true">IMPACT</span>
  <div class="container">
    <div class="impact-grid grid-2">
      <div class="reveal">
        <span class="eyebrow ew-red" style="margin-bottom:24px">Real Numbers</span>
        <p class="impact-pull t-pullquote">Every amount has a<br/><span class="red">specific, trackable</span><br/>real-world result.</p>
        <div class="impact-body t-body">
      ...
      <div class="reveal rd2">
        <div class="impact-table bordered-list">
          <div class="it-row bordered-list-item"><div class="it-amt">$3<small>UGX 11,000</small></div><p class="it-desc">Project materials for one student leader for a full term</p><span class="it-tag tag-n">SLF</span></div>
          <div class="it-row bordered-list-item"><div class="it-amt">$5<small>UGX 18,500</small></div><p class="it-desc">Reusable pads — keeps one girl in school for a full year</p><span class="it-tag tag-r">RED</span></div>
          <div class="it-row bordered-list-item"><div class="it-amt">$7<small>UGX 26,000</small></div><p class="it-desc">Clean water access for 10 people for one month</p><span class="it-tag tag-t">Water</span></div>
          <div class="it-row bordered-list-item"><div class="it-amt">$14<small>UGX 52,000</small></div><p class="it-desc">Plants and nurtures 5 fruit trees in a school compound</p><span class="it-tag tag-t">Green</span></div>
          <div class="it-row bordered-list-item"><div class="it-amt">$27<small>UGX 100,000</small></div><p class="it-desc">Full hygiene education session for an entire school</p><span class="it-tag tag-r">RED</span></div>
          <div class="it-row bordered-list-item"><div class="it-amt">$54<small>UGX 200,000</small></div><p class="it-desc">YoSkills weekend course for 10+ young entrepreneurs</p><span class="it-tag tag-g">Skills</span></div>
          <div class="it-row bordered-list-item"><div class="it-amt">$135<small>UGX 500,000</small></div><p class="it-desc">Launches a new YAP community chapter in a village</p><span class="it-tag tag-n">YAP</span></div>
        </div>
      </div>
    </div>
  </div>
...
<section id="how" class="section-navy">
  <div class="halftone halftone-light"></div>
  <div class="container">
    <div class="how-grid grid-2-center">
      <div class="reveal">
        <span class="eyebrow ew-white" style="margin-bottom:24px">Full Transparency</span>
        <p class="how-big t-pullquote"><span class="y">We don't hide</span><br/>where the money<br/><span class="r">actually goes.</span></p>
        <div class="how-sub t-body">
      ...
      <div class="reveal rd2">
        <div class="how-list bordered-list-dark">
          <div class="how-item bordered-list-dark-item"><span class="how-n">01</span><div class="how-t"><strong>You give</strong><span>MTN, Airtel, card or PayPal — any amount from $3 / UGX 11,000.</span></div></div>
          <div class="how-item bordered-list-dark-item"><span class="how-n">02</span><div class="how-t"><strong>Instant acknowledgement</strong><span>Personal thank-you from McMike within 24 hours. Always.</span></div></div>
          <div class="how-item bordered-list-dark-item"><span class="how-n">03</span><div class="how-t"><strong>Funds allocated</strong><span>To your chosen programme — or the general fund where it's needed most.</span></div></div>
          <div class="how-item bordered-list-dark-item"><span class="how-n">04</span><div class="how-t"><strong>Youth execute</strong><span>Young people design, run, and report on every project. No external consultants, no overhead bloat.</span></div></div>
          <div class="how-item bordered-list-dark-item"><span class="how-n">05</span><div class="how-t"><strong>You see it happen</strong><span>Photo updates, impact data, and annual reports keep you connected to what your money built.</span></div></div>
        </div>
      </div>
    </div>
  </div>
...
<!-- ④ FINAL CTA -->
<section id="finalcta-c" class="section-red">
  <div class="halftone"></div>
  <div class="container">
    <div class="fc-inner cta-section reveal">
      <span class="eyebrow ew-white">Ready?</span>
      <h2 class="fc-h cta-section-h">Seeds grow<br/>when planted.</h2>
      <p class="fc-p cta-section-p">Whatever you give — it becomes a girl in school, a clean cup of water, a young person who knows they matter.</p>
      <div class="fc-btns cta-section-btns">
