...
/* ─── 1. HERO ─── */
#yap-hero { min-height: 88svh; }
.yh-split { display: grid; grid-template-columns: 1fr 420px; min-height: 88svh; position: relative; z-index: 1; }
.yh-left { display: flex; flex-direction: column; justify-content: flex-end; padding: 52px 48px 0; border-right: var(--b); }
.yh-right { display: flex; flex-direction: column; overflow: hidden; }
.yh-photo { flex: 1; border-bottom: var(--b); }
.yh-photo:last-child { border-bottom: none; }
.yh-tag { font-family: var(--font-ui); font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: .28em; color: rgba(255,255,255,.35); display: block; margin-bottom: 18px; }
.yh-h1 { font-family: var(--font-head); font-size: clamp(48px, 8vw, 104px); font-weight: 900; line-height: .88; letter-spacing: -.04em; text-transform: uppercase; color: #fff; }
.yh-h1 em { font-style: italic; color: var(--teal); }
.yh-sub { font-size: clamp(14px, 1.5vw, 18px); font-weight: 500; color: rgba(255,255,255,.55); line-height: 1.75; max-width: 480px; margin: 18px 0 28px; }
...
/* ─── PHOTO BREAK ─── */
#yap-photobreak { height: 320px; }
.ypb { border-right: var(--b); }
...
/* ─── 2. WHAT IS YAP ─── */
.yw-pull { font-family: var(--font-head); font-size: clamp(20px,2.8vw,32px); font-weight: 900; line-height: 1.2; font-style: italic; color: var(--navy); margin-bottom: 24px; }
.yw-pull .red { color: var(--red); }
.yw-body { font-size: 16px; line-height: 1.85; font-weight: 500; color: rgba(29,38,49,.72); }
.yw-body p + p { margin-top: 16px; }
.group-list { box-shadow: var(--shadow); margin-top: 32px; }
.group-row { display: flex; align-items: flex-start; gap: 18px; }
.group-tag { font-family: var(--font-ui); font-size: 8px; font-weight: 700; text-transform: uppercase; letter-spacing: .14em; padding: 3px 10px; border: var(--b-thin); flex-shrink: 0; margin-top: 2px; white-space: nowrap; color: var(--navy); }
...
.yw-problem { background: var(--navy); border: var(--b); padding: 28px 28px 0; box-shadow: var(--shadow); }
.yw-problem-h { font-family: var(--font-head); font-size: 12px; font-weight: 900; text-transform: uppercase; letter-spacing: .1em; color: rgba(255,255,255,.38); margin-bottom: 18px; }
.yw-prob-row { padding: 14px 0; border-bottom: 1px solid rgba(255,255,255,.08); display: flex; align-items: flex-start; gap: 12px; }
...
.yw-arrow { background: var(--teal); border: var(--b); border-top: none; padding: 14px 28px; display: flex; align-items: center; gap: 12px; }
.yw-arrow-text { font-family: var(--font-head); font-size: 13px; font-weight: 900; text-transform: uppercase; font-style: italic; color: var(--navy); }
.yw-after { background: var(--cream); border: var(--b); border-top: none; overflow: hidden; }
.yw-after-row { padding: 13px 20px; border-bottom: var(--b); display: flex; align-items: center; gap: 12px; background: var(--cream); transition: background .15s; }
.yw-after-row:last-child { border-bottom: none; }
.yw-after-row:hover { background: #fff; }
.yw-tick { font-family: var(--font-head); font-size: 13px; font-weight: 900; color: var(--teal); flex-shrink: 0; }
.yw-after-text { font-size: 13px; font-weight: 700; color: var(--navy); }

/* ─── 3. PILLARS ─── */
.pillar-track { margin-top: 48px; }
.pillar { padding: 36px 26px; transition: background .18s; }
...
.pillar-num { font-family: var(--font-head); font-size: clamp(22px,2.5vw,30px); font-weight: 900; font-style: italic; line-height: 1; margin-bottom: 12px; }
...
.pillar-name { font-family: var(--font-head); font-size: 13px; font-weight: 800; text-transform: uppercase; letter-spacing: .06em; margin-bottom: 10px; }
.pillar-desc { font-size: 13px; font-weight: 500; color: rgba(29,38,49,.62); line-height: 1.65; margin-bottom: 20px; flex: 1; }
.pillar-items { display: flex; flex-direction: column; gap: 6px; }
.pillar-item { font-size: 11px; font-weight: 600; color: rgba(29,38,49,.58); display: flex; align-items: flex-start; gap: 7px; line-height: 1.4; }
...
/* ─── 4. WHAT MAKES YAP DIFFERENT ─── */
.yd-big { font-family: var(--font-head); font-size: clamp(26px,3.8vw,46px); font-weight: 900; line-height: 1.1; font-style: italic; color: #fff; }
.yd-big .teal   { color: var(--teal); }
.yd-big .yellow { color: var(--yellow); }
.yd-body { font-size: 15px; line-height: 1.85; font-weight: 500; color: rgba(255,255,255,.55); margin-top: 22px; }
.yd-body p + p { margin-top: 14px; }
.diff-vs { display: flex; flex-direction: column; gap: 4px; flex: 1; }
.diff-bad { font-size: 11px; font-weight: 600; color: rgba(255,255,255,.28); text-decoration: line-through; line-height: 1.4; }
.diff-good { font-size: 14px; font-weight: 700; color: #fff; line-height: 1.4; }
.diff-good .teal { color: var(--teal); }

/* ─── 5. IMPACT AREAS ─── */
.impact-wm-yap { position: absolute; bottom: -10px; left: -20px; font-family: var(--font-head); font-size: clamp(90px,14vw,170px); font-weight: 900; color: rgba(29,38,49,.04); letter-spacing: -.05em; pointer-events: none; user-select: none; white-space: nowrap; }
.impact-hex { margin-top: 48px; }
.ihex { padding: 32px 28px; gap: 10px; background: #fff; transition: background .18s; }
.ihex:nth-child(3n){ border-right: none; }
.ihex:nth-last-child(-n+3){ border-bottom: none; }
.ihex:hover { background: var(--cream); }
.ihex-num { font-family: var(--font-head); font-size: 10px; font-weight: 900; text-transform: uppercase; letter-spacing: .12em; color: rgba(29,38,49,.25); }
.ihex-name { font-family: var(--font-head); font-size: 15px; font-weight: 900; text-transform: uppercase; font-style: italic; line-height: 1; }
.ihex-desc { font-size: 13px; font-weight: 500; color: rgba(29,38,49,.6); line-height: 1.6; }
...
/* ─── 6. WHERE WE ARE NOW ─── */
.yn-h { font-family: var(--font-head); font-size: clamp(30px,4.5vw,54px); font-weight: 900; line-height: .92; text-transform: uppercase; font-style: italic; color: var(--navy); margin: 16px 0 20px; }
.yn-h span { color: var(--red); }
.yn-body { font-size: 15px; font-weight: 500; line-height: 1.8; color: rgba(29,38,49,.7); margin-bottom: 24px; }
.yn-status { box-shadow: var(--shadow); }
.yn-row { padding: 15px 20px; display: flex; align-items: center; gap: 14px; }
.yn-dot { width: 10px; height: 10px; border-radius: 50%; flex-shrink: 0; background: var(--teal); border: 2px solid var(--navy); }
...
.yn-vision { background: var(--navy); border: var(--b); padding: 36px; box-shadow: var(--shadow); }
.yn-vision-eyebrow { font-family: var(--font-ui); font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: .22em; color: rgba(255,255,255,.35); display: block; margin-bottom: 16px; }
.yn-vision-h { font-family: var(--font-head); font-size: clamp(18px,2.2vw,26px); font-weight: 900; font-style: italic; line-height: 1.1; color: #fff; margin-bottom: 20px; }
.yn-vision-h .yellow { color: var(--yellow); }
.yn-v-list { display: flex; flex-direction: column; gap: 10px; }
.yn-v-row { display: flex; align-items: flex-start; gap: 14px; padding: 14px 16px; background: rgba(255,255,255,.05); border: 1px solid rgba(255,255,255,.08); }
.yn-v-label { font-family: var(--font-head); font-size: 11px; font-weight: 900; text-transform: uppercase; letter-spacing: .06em; color: var(--teal); flex-shrink: 0; min-width: 88px; padding-top: 2px; }
.yn-v-text { font-size: 13px; font-weight: 500; color: rgba(255,255,255,.62); line-height: 1.55; }
.yn-closing { font-family: var(--font-head); font-size: 11px; font-weight: 900; text-transform: uppercase; font-style: italic; color: rgba(255,255,255,.25); margin-top: 18px; letter-spacing: .06em; }

/* ─── 7. GET INVOLVED ─── */
.join-grid { margin-top: 48px; }
.jcard { transition: filter .2s; }
.jcard:hover { filter: brightness(.97); }
.jc-list { display: flex; flex-direction: column; gap: 7px; margin-bottom: 22px; }

/* ─── 8. FINAL CTA ─── */
#yap-cta { border-top: var(--b); border-bottom: none; }
...
<!-- ① HERO -->
<section id="yap-hero" class="section-navy">
  ...
  <div class="yh-split">
    ...
    <div class="yh-left reveal">
      ...
      <div class="yh-strip stat-strip">
        <div class="yh-cell stat-strip-cell">
          <span class="yh-num stat-strip-num">2</span>
          <span class="yh-lbl stat-strip-lbl">Active Chapters</span>
        </div>
        <div class="yh-cell stat-strip-cell">
          <span class="yh-num stat-strip-num">Buwama</span>
          <span class="yh-lbl stat-strip-lbl">&amp; Kayabwe</span>
        </div>
        <div class="yh-cell stat-strip-cell">
          <span class="yh-num stat-strip-num">2021</span>
          <span class="yh-lbl stat-strip-lbl">Since</span>
        </div>
        <div class="yh-cell stat-strip-cell">
          <span class="yh-num stat-strip-num">Mpigi</span>
          <span class="yh-lbl stat-strip-lbl">→ Butambala</span>
        </div>
      </div>
    </div>
    ...
    <div class="yh-right">
      <div class="yh-photo img-wrap img-grayscale">
        ...
        <span class="yh-photo-lbl img-overlay-label">Buwama Chapter · Community session</span>
      </div>
      <div class="yh-photo img-wrap img-grayscale">
        ...
        <span class="yh-photo-lbl img-overlay-label">Kayabwe Chapter · Project work</span>
      </div>
    </div>
...
<!-- ② WHAT IS YAP  (cream) -->
<section id="yap-what" class="section-cream">
  <span class="yw-wm watermark" aria-hidden="true">YAP</span>
  <div class="container">
    <div class="yw-grid grid-2">
      ...
      <div class="reveal">
        ...
        <div class="group-list bordered-list">
          <div class="group-row bordered-list-item">
...
<section id="yap-pillars" class="section-white">
  <div class="container">
    ...
    <div class="pillar-track grid-4 reveal">

      <div class="pillar grid-card">
...
<div id="yap-photobreak" class="photo-strip-3">
  <div class="ypb img-wrap img-grayscale-light">
    ...
    <span class="ypb-lbl img-overlay-label-slide">Buwama Chapter · Community action project</span>
  </div>
  <div class="ypb img-wrap img-grayscale-light">
    ...
    <span class="ypb-lbl img-overlay-label-slide">YoSkills · Enterprise training</span>
  </div>
  <div class="ypb img-wrap img-grayscale-light">
    ...
    <span class="ypb-lbl img-overlay-label-slide">Financial literacy · Stanbic partnership</span>
  </div>
</div>

<!-- ④ WHAT MAKES YAP DIFFERENT  (navy) -->
<section id="yap-different" class="section-navy">
  <div class="halftone halftone-light"></div>
  <div class="container">
    <div class="yd-grid grid-2-center">
      ...
      <div class="reveal rd2">
        <div class="diff-list bordered-list-dark">
          <div class="diff-row bordered-list-dark-item">
            <div class="diff-vs">
...
<!-- ⑤ IMPACT AREAS  (cream) -->
<section id="yap-impact" class="section-cream">
  ...
  <div class="container">
    ...
    <div class="impact-hex grid-3-tight reveal">
      <div class="ihex grid-card">
...
<section id="yap-now" class="section-white">
  <div class="container">
    <div class="yn-grid grid-2">
      <div class="reveal">
        ...
        <div class="yn-status bordered-list">
          <div class="yn-row bordered-list-item">
...
<!-- ⑦ GET INVOLVED  (cream) -->
<section id="yap-join" class="section-cream">
  <div class="container">
    <div class="reveal" style="text-align:center">
    ...
    <div class="join-grid grid-3 reveal">

      <div class="jcard jc-navy grid-card grid-card-navy">
        <span class="jc-tag grid-card-tag">01 — Youth Groups</span>
        <h3 class="jc-h grid-card-h">Register a<br/>Chapter</h3>
        <p class="jc-body grid-card-body">If your group is in Mpigi or Butambala and meets regularly — savings circle, sports team, faith group, or informal meetup — you can register as a YAP Chapter and access the full support pathway.</p>
        <div class="jc-list">
          <div class="jc-li grid-card-li">At least 10 active, committed members</div>
          <div class="jc-li grid-card-li">Appoint a chapter lead and a secretary</div>
          <div class="jc-li grid-card-li">Agree to structured meetings and documentation</div>
          <div class="jc-li grid-card-li">Complete YoSkills foundation training as a group</div>
        </div>
        <a href="contact.php" class="btn btn-white btn-sm">Register Your Group →</a>
      </div>

      <div class="jcard jc-teal grid-card grid-card-teal">
        <span class="jc-tag grid-card-tag">02 — Donors</span>
        <h3 class="jc-h grid-card-h">Fund a<br/>Chapter</h3>
        <p class="jc-body grid-card-body">Sponsoring a YAP Chapter covers training, toolkits, financial linkage sessions, and monitoring support across a full year. You can name the chapter and receive quarterly reports on how it is developing.</p>
        <div class="jc-list">
          <div class="jc-li grid-card-li">From UGX 500,000 / $135 to launch one chapter</div>
          <div class="jc-li grid-card-li">Named chapter sponsorship available</div>
          <div class="jc-li grid-card-li">Quarterly progress reports, documented outcomes</div>
          <div class="jc-li grid-card-li">Invitation to the annual Innovation Summit</div>
        </div>
        <a href="campaign.php" class="btn btn-navy btn-sm">Fund a Chapter →</a>
      </div>

      <div class="jcard jc-yellow grid-card grid-card-yellow">
        <span class="jc-tag grid-card-tag">03 — Organisations</span>
        <h3 class="jc-h grid-card-h">Partner<br/>With Us</h3>
        <p class="jc-body grid-card-body">Banks, government bodies, NGOs, and businesses can enter a formal partnership — delivering financial literacy sessions, providing mentorship, opening market access, or co-funding the Innovation Summit.</p>
        <div class="jc-list">
          <div class="jc-li grid-card-li">Co-deliver skills or financial literacy training</div>
          <div class="jc-li grid-card-li">Offer mentorship or market access to chapter enterprises</div>
          <div class="jc-li grid-card-li">Co-fund or co-brand the Innovation Summit</div>
          <div class="jc-li grid-card-li">Commission research or impact evaluation</div>
        </div>
...
<!-- ⑧ FINAL CTA  (navy) -->
<section id="yap-cta" class="section-navy">
  <div class="halftone halftone-light"></div>
  <div class="container">
    <div class="yap-cta-inner cta-section reveal">
      <span class="eyebrow ew-white">The Pathway Starts Here</span>
      <h2 class="yap-cta-h cta-section-h">Structure is what<br/>turns a group into<br/>an <em>enterprise.</em></h2>
      <p class="yap-cta-p cta-section-p">Two chapters are active. More are in the pipeline. If your group is ready to move from informal to organised — or if you want to fund that shift — get in touch.</p>
      <div class="yap-cta-btns cta-section-btns">
      ...
      <p class="yap-cta-note cta-section-note">YAP Chapters · Mpigi &amp; Butambala · Est. 2021 · info@omuto.org</p>
    </div>
  </div>
</section>
